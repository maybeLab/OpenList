...
(?U)access_token=(.*)&`,
		...
		{Key: conf.TaskThumbnailThreadsNum, Value: strconv.Itoa(conf.Conf.Tasks.Thumbnail.Workers), Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailFFmpegThreadsNum, Value: "2", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailDefaultWidth, Value: "480", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailDefaultQuality, Value: "75", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailVideoSecond, Value: "3", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailImageTimeout, Value: "60", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailVideoTimeout, Value: "120", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
		{Key: conf.ThumbnailMinFreeSpace, Value: "512", Type: conf.TypeNumber, Group: model.TRAFFIC, Flag: model.PRIVATE},
